...
return [
    ...
    'hazard_class_names' => [
        ...
        'Flammable Aerosols'                      => 'Entzündbare Aerosole',
        'Flammable Liquids'                       => 'Entzündbare Flüssigkeiten',
        'Flammable Solids'                        => 'Entzündbare Feststoffe',
        'Self-Reactive Substances'                => 'Selbstzersetzliche Stoffe und Gemische',
        'Pyrophoric Liquids'                      => 'Pyrophore Flüssigkeiten',
        'Pyrophoric Solids'                       => 'Pyrophore Feststoffe',
        'Self-Heating Substances'                 => 'Selbsterhitzungsfähige Stoffe und Gemische',
        'Substances which, in contact with water, emit flammable gases' => 'Stoffe und Gemische, die in Berührung mit Wasser entzündbare Gase entwickeln',
        ...
        // Health hazards
        'Acute Toxicity (Oral)'                   => 'Akute Toxizität (oral)',
        'Acute Toxicity (Dermal)'                 => 'Akute Toxizität (dermal)',
        'Acute Toxicity (Inhalation)'             => 'Akute Toxizität (inhalativ)',
        ...
        'STOT — Single Exposure'                  => 'Spezifische Zielorgan-Toxizität — einmalige Exposition',
        'STOT — Repeated Exposure'                => 'Spezifische Zielorgan-Toxizität — wiederholte Exposition',
    ...
    // ──────────────────────────────────────────────
    'category_names' => [
        'Division 1.1'         => 'Unterklasse 1.1',
        'Division 1.2'         => 'Unterklasse 1.2',
        'Division 1.3'         => 'Unterklasse 1.3',
        'Division 1.4'         => 'Unterklasse 1.4',
        'Division 1.5'         => 'Unterklasse 1.5',
        'Category 1'           => 'Kategorie 1',
        'Category 2'           => 'Kategorie 2',
        'Category 3'           => 'Kategorie 3',
        'Category 4'           => 'Kategorie 4',
        'Category 5'           => 'Kategorie 5',
        'Category 1 (1A/1B)'   => 'Kategorie 1 (1A/1B)',
        'Category 1 (1A/1B/1C)' => 'Kategorie 1 (1A/1B/1C)',
        'Category 1A'          => 'Kategorie 1A',
        'Category 1B'          => 'Kategorie 1B',
        'Category 2A'          => 'Kategorie 2A',
        'Category 2B'          => 'Kategorie 2B',
        'Category 3 (Respiratory Irritation)' => 'Kategorie 3 (Reizung der Atemwege)',
        'Category 3 (Narcotic Effects)'       => 'Kategorie 3 (Narkotische Wirkungen)',
        'Type A'               => 'Typ A',
        'Type B'               => 'Typ B',
        'Type C & D'           => 'Typ C und D',
        'Type E & F'           => 'Typ E und F',
        'Compressed gas'       => 'Verdichtetes Gas',
        'Liquefied gas'        => 'Verflüssigtes Gas',
        'Refrigerated liquefied gas' => 'Tiefgekühlt verflüssigtes Gas',
        'Dissolved gas'        => 'Gelöstes Gas',
        'Lactation'            => 'Laktation',
    ],
];
