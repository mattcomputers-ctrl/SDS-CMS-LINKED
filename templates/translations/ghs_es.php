...
return [
    ...
    'hazard_class_names' => [
        ...
        'Flammable Aerosols'                      => 'Aerosoles inflamables',
        'Flammable Liquids'                       => 'Líquidos inflamables',
        'Flammable Solids'                        => 'Sólidos inflamables',
        'Self-Reactive Substances'                => 'Sustancias y mezclas que reaccionan espontáneamente',
        'Pyrophoric Liquids'                      => 'Líquidos pirofóricos',
        'Pyrophoric Solids'                       => 'Sólidos pirofóricos',
        'Self-Heating Substances'                 => 'Sustancias y mezclas que experimentan calentamiento espontáneo',
        'Substances which, in contact with water, emit flammable gases' => 'Sustancias y mezclas que, en contacto con el agua, desprenden gases inflamables',
        ...
        // Health hazards
        'Acute Toxicity (Oral)'                   => 'Toxicidad aguda (oral)',
        'Acute Toxicity (Dermal)'                 => 'Toxicidad aguda (cutánea)',
        'Acute Toxicity (Inhalation)'             => 'Toxicidad aguda (por inhalación)',
        ...
        'STOT — Single Exposure'                  => 'Toxicidad específica en determinados órganos — exposición única',
        'STOT — Repeated Exposure'                => 'Toxicidad específica en determinados órganos — exposiciones repetidas',
        'Aspiration Hazard'                       => 'Peligro por aspiración',

        // Environmental hazards
        'Hazardous to the Aquatic Environment (Acute)'   => 'Peligroso para el medio ambiente acuático — peligro agudo',
        'Hazardous to the Aquatic Environment (Chronic)'  => 'Peligroso para el medio ambiente acuático — peligro crónico',
    ...
    // ──────────────────────────────────────────────
    'category_names' => [
        'Division 1.1'         => 'División 1.1',
        'Division 1.2'         => 'División 1.2',
        'Division 1.3'         => 'División 1.3',
        'Division 1.4'         => 'División 1.4',
        'Division 1.5'         => 'División 1.5',
        'Category 1'           => 'Categoría 1',
        'Category 2'           => 'Categoría 2',
        'Category 3'           => 'Categoría 3',
        'Category 4'           => 'Categoría 4',
        'Category 5'           => 'Categoría 5',
        'Category 1 (1A/1B)'   => 'Categoría 1 (1A/1B)',
        'Category 1 (1A/1B/1C)' => 'Categoría 1 (1A/1B/1C)',
        'Category 1A'          => 'Categoría 1A',
        'Category 1B'          => 'Categoría 1B',
        'Category 2A'          => 'Categoría 2A',
        'Category 2B'          => 'Categoría 2B',
        'Category 3 (Respiratory Irritation)' => 'Categoría 3 (Irritación de las vías respiratorias)',
        'Category 3 (Narcotic Effects)'       => 'Categoría 3 (Efectos narcóticos)',
        'Type A'               => 'Tipo A',
        'Type B'               => 'Tipo B',
        'Type C & D'           => 'Tipo C y D',
        'Type E & F'           => 'Tipo E y F',
        ...
        'Refrigerated liquefied gas' => 'Gas licuado refrigerado',
        'Dissolved gas'        => 'Gas disuelto',
        'Lactation'            => 'Lactancia',
    ],
];
