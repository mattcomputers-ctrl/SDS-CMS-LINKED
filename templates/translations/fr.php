...
return [
    ...
    'section2' => [
        ...
        'not_classified' => 'N\'est pas une substance ou un mélange dangereux.',
    ],
    'section3' => [
    ...
    'section4' => [
        ...
        'inhalation_fatal'     => 'Transporter IMMÉDIATEMENT la personne à l\'air frais. En cas d\'arrêt respiratoire, pratiquer la respiration artificielle. Appeler immédiatement un centre antipoison ou un médecin.',
        'inhalation_toxic'     => 'Transporter immédiatement à l\'air frais. En cas de difficultés respiratoires, administrer de l\'oxygène. Consulter immédiatement un médecin.',
        'skin_corrosive'       => 'Rincer immédiatement la peau avec de l\'eau abondante pendant au moins 20 minutes. Retirer tous les vêtements et chaussures contaminés. Consulter immédiatement un médecin. Laver les vêtements contaminés avant réutilisation.',
        'skin_sensitizer'      => 'Retirer les vêtements contaminés. Laver la peau avec de l\'eau et du savon. En cas de réaction allergique, consulter un médecin. Éviter toute exposition future.',
        'eyes_corrosive'       => 'Rincer immédiatement les yeux avec de l\'eau abondante pendant au moins 30 minutes. Consulter immédiatement un médecin. Ne pas laisser la victime se frotter les yeux.',
        'eyes_serious_damage'  => 'Rincer immédiatement les yeux avec de l\'eau abondante pendant au moins 20 minutes. Consulter immédiatement un médecin.',
        'ingestion_aspiration' => 'NE PAS provoquer de vomissements — risque d\'aspiration. En cas de vomissement spontané, maintenir la tête en position basse. Consulter immédiatement un médecin.',
        'ingestion_toxic'      => 'Rincer la bouche avec de l\'eau. Ne pas provoquer de vomissements sauf indication du personnel médical. Appeler immédiatement un centre antipoison ou un médecin.',
    ],
    'section5' => [
        ...
        'unsuitable_water_reactive' => 'NE PAS utiliser d\'eau. Le produit réagit avec l\'eau. Utiliser de la poudre chimique sèche, du sable sec ou du dioxyde de carbone (CO2).',
        'suitable_oxidizer'         => 'Pulvérisation d\'eau (grandes quantités), mousse. Ne pas utiliser de poudre chimique sèche sur les grands incendies impliquant des oxydants.',
        'specific_hazards_oxidizer' => 'Oxydant — peut intensifier le feu. La combustion peut produire du monoxyde de carbone et d\'autres gaz toxiques.',
        'specific_hazards_organic_peroxide' => 'Peut s\'enflammer ou exploser en cas de chauffage. La combustion peut produire du monoxyde de carbone et d\'autres gaz toxiques.',
    ...
    'section6' => [
        ...
        'precautions_corrosive'    => 'Utiliser les EPI appropriés y compris combinaison chimique, gants et écran facial (voir Section 8). Éviter tout contact avec la peau et les yeux. Évacuer le personnel non protégé.',
        ...
        'containment_liquid'       => 'Arrêter la fuite si possible en toute sécurité. Endiguer ou contenir le déversement. Absorber avec un matériau inerte absorbant. Collecter dans des récipients adaptés.',
        'containment_solid'        => 'Éviter la formation de poussière. Balayer ou aspirer le matériau. Collecter dans des récipients adaptés.',
    ],
    'section7' => [
        ...
        'handling_oxidizer'        => 'Tenir à l\'écart des matériaux combustibles, de la chaleur et des sources d\'ignition. Ne pas mélanger avec des matériaux inflammables ou combustibles.',
        ...
        'handling_self_reactive'   => 'Tenir à l\'écart de la chaleur. Manipuler et ouvrir le récipient avec précaution.',
        'storage_flammable'        => 'Stocker dans un endroit frais, sec et bien ventilé, à l\'écart de la chaleur et des sources d\'ignition. Maintenir les récipients fermés. Mettre à la terre les récipients lors du transfert.',
    ...
    'labels' => [
        ...
        'ppe_wear_gloves'       => 'Porter des Gants',
        'ppe_wear_respiratory'  => 'Porter une Protection Respiratoire',
        'ppe_wear_skin'         => 'Porter des Vêtements de Protection',
        ...
        'skin_contact'          => 'Contact avec la Peau',
        'eye_contact'           => 'Contact avec les Yeux',
        'ingestion'             => 'Ingestion',
        'notes_to_physician'    => 'Notes pour le Médecin',

        // Section 5 (Fire-Fighting)
        'suitable_media'        => 'Moyens d\'Extinction Appropriés',
        'unsuitable_media'      => 'Moyens d\'Extinction Non Appropriés',
        'specific_hazards'      => 'Dangers Spécifiques',
        'firefighter_advice'    => 'Conseils aux Pompiers',

        // Section 6 (Accidental Release)
        'personal_precautions'  => 'Précautions Individuelles',
        'environmental_precautions' => 'Précautions Environnementales',
        'containment_cleanup'   => 'Confinement et Nettoyage',
        ...
        'chemical_stability'    => 'Stabilité Chimique',
        'conditions_avoid'      => 'Conditions à Éviter',
        'incompatible_materials' => 'Matériaux Incompatibles',
        'decomposition_products' => 'Produits de Décomposition Dangereux',

        // Section 11 (Toxicological Information)
        'acute_toxicity'        => 'Toxicité Aiguë',
        ...
        'persistence'           => 'Persistance et Dégradabilité',
        'bioaccumulation'       => 'Potentiel de Bioaccumulation',
        ...
        'tsca_status'           => 'Statut TSCA',
        'sara_313_title'        => 'SARA 313 / Déclaration TRI',
        'hap_title'             => 'Clean Air Act Section 112(b) — Polluants Atmosphériques Dangereux (HAP)',
        'hap_triggering'        => 'Chimique HAP Déclencheur',
        'hap_wt_pct'            => '% en Poids dans la Formule',
        'hap_total'             => 'Teneur Totale en HAP',
